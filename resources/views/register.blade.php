...
<div class="container register">
    <div class="row">
        <div class="col-md-3 register-left">
            ...
            <h3>Xin Chào</h3>
            <button><a href="{{route('login')}}">Đăng Nhập</a></button>
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="row register-form">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input id="confirm" type="password" class="form-control" placeholder="Confirm Password *" name="confirm" />
                                </div>
                                <input type="submit" class="btn-submit" name="btnRegister" disabled value="Đăng Ký"/>
                            </div>
                        </div>
                    </div>
                </div>
